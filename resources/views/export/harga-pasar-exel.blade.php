    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border: solid">‎ Rp{{ number_format($item->harga, 0, ',', '.') }} ‎ </td>
                <td style="border: solid">‎ {{ !empty($item->faktor_eksternal) ? implode(', ', $item->faktor_eksternal)
                    : '-' }} ‎ </td>
                <td style="border: solid">‎ {{$item->sumber_data }} ‎ </td>
            </tr>
            @endforeach
        </tbody>
    </table>
